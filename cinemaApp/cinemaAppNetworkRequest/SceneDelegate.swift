...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        tabBarController.tabBar.barTintColor = Colors.mainGray
        
        let mainScreen = MainScreenController()
        mainScreen.tabBarItem = UITabBarItem(title: "Главная", image: UIImage(systemName: "play.house"), tag: 0)
        ...
        let favouriteFilmsScreen = FavouriteFilmsController()
        favouriteFilmsScreen.tabBarItem = UITabBarItem(title: "Избранное", image: UIImage(systemName: "bookmark"), tag: 1)
